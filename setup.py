...
janitoo_entry_points = {
    "janitoo.threads": [
        "voxgen = janitoo_voxgenerator.thread_voxgenerator:make_thread",
    ],
    "janitoo.components": [
        "voxgen.listener = janitoo_voxgenerator.voxgenerator:make_listener",
    ],
}

setup(
    name = 'janitoo_voxgenerator',
    ...
    dependency_links = [
      ...
      'https://github.com/bibi21000/VOXGenerator/archive/master.zip#egg=voxgenerator',
    ],
